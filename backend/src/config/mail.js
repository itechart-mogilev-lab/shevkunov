...
module.exports.mailForVerify = (name, token, host)=>{
    const content = `${name}, пожалуйста перейдите по ссылке http://${host}/auth/confirmation/${token} для подтверждения вашей учетной записи`;
